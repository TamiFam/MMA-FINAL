      ...
      if(user) {
        ...
        .then(()=> {
          ...
          if(user.email && user.displayName) {
            return axios.post(`https://mma-server-x3l2.onrender.com/new-user`   //https://mma-server-x3l2.onrender.com
  ...
  return (
    <div className="flex justify-center items-center pt-14 bg-gray-100">
      <div className='bg-white p-8 rounded-lg shadow-md'>
        <h2 className='text-2xl font-medium t text-center mb-6'>Register</h2>
        {/*form data */}
        ...
        <option value="other">gay(не желетельно)</option>
              ...
              Address
                ...
                <textarea  rows={1}  placeholder='Enter Address'{...register("address", {required: true})} className='w-full border border-gray-300
                 rounded-md py-2 px-4 focus:outline-none focus:ring focus:border-blue-300'>
          ...
          <div className='text-center'>
            <button type='submit' className='  px-4 py-2 bg-secondary hover:bg-red-500 text-white rounded-md  '>Register</button>
            {
